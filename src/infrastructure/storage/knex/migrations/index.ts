...
import { addRequestMetadataCreatedAtIndex } from './add-request-metadata-created-at-index';
...
export const SISP_MIGRATIONS: readonly SispMigration[] = [
  ...
  {
    name: '0008_add_request_metadata_created_at_index',
    up: addRequestMetadataCreatedAtIndex,
  },
];
